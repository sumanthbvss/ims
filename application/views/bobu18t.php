...
<img src="..\image\Rear_bobu18t.png" style="position: absolute; left: 850px; top: 235px; height:210px; width: 223px;" />

<img src="..\image\RHS_bobu18t.png" style="position: absolute; left: 853px; top: 463px;height:305px; width: 242px;" />
<img src="..\image\pic79.png" style="position: absolute; left: 853px; top: 788px;height:265px; width: 242px;" />
<img src="..\image\LHS_bobu18t.png" style="position: absolute; left: 853px; top: 1068px;height:315px; width: 252px;" />
<img src="..\image\Top_bobu18t.png" style="position: absolute; left: 853px; top: 1400px;height:255px; width: 242px;" />
<img src="..\image\bottom_bobu18t.png" style="position: absolute; left: 853px; top: 1650px;height:205px; width: 222px;" />
...
<table width="1172" height="65" border="1">
  <tr>
   <th width="598" height="59"  valign="center" style="font: bold 15px Times New Roman" scope="row"><p>18T Iso frame record inspection</p>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 234px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 468px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td width="81" align="center">7</td>
    <td   style="font: bold 20px Times New Roman" width="231">Ladder</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSLadder ?>" name="RHSLadder" width ="70%"id="fe165" /></td>
    
  </tr>
  <tr>
   <td width="81" align="center">8</td>
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontDiagonal ?>" name="rear8" width ="70%"id="fe166" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">9</td>
    <td  style="font: bold 20px Times New Roman">Front Sidepost</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSidePost ?>" name="rear9" width ="70%"id="fe167" /></td>
  
  </tr>
  <tr>
    <td align="center">10</td>
    <td  style="font: bold 20px Times New Roman">Front Saddle</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSaddle ?>" name="rear10" width ="70%"id="fe168" /></td>

  </tr>
  <tr>
    <td height="31" align="center">11</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSBottomRail ?>" name="rear11" width ="70%"id="fe169" /></td>
  
  </tr>
  <tr>
    <td  align="center">12</td>
    <td style="font: bold 20px Times New Roman">Saddle Guesset</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSSaddleGusset ?>"name="rear12" width ="70%"id="fe170" /></td>
    
  </tr>
  <tr>
    <td  align="center">13</td>
    <td style="font: bold 20px Times New Roman">Rear Saddle</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text" value="<?php echo $row->RHSRearSaddle ?>"name="rear13" width ="70%"id="fe171" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">14</td>
    <td>Rear Sidepost</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSRearSidePost ?>"name="rear14" width ="70%"id="fe172" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">15</td>
    <td>Rear Diagonal</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSRearDiagonal ?>" name="rear15" width ="70%"id="fe173" /></td>
  </tr>
  <tr>
    <td align="center" style="font: bold 20px Times New Roman">16</td>
    <td>Diagonal Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSDiagonalGusset ?>" name="rear16" width ="70%"id="fe174" /></td>
  </tr>
  <tr>
    <td height="27" align="center" style="font: bold 20px Times New Roman">17</td>
    <td>Corner Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSCornerGusset ?>" name="rear17" width ="70%"id="fe175" /></td>
  </tr>
</table>

<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 854px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 1048px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td width="81" align="center">24</td>
    <td   style="font: bold 20px Times New Roman" width="231">platform support</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSPlatformSupport ?>" name="LHS24_bobu18t" width ="70%"id="fe180" /></td>
  ...
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonal ?>" name="rear25" width ="70%"id="fe181" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">26</td>
    <td  style="font: bold 20px Times New Roman">Front Sidepost</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontSidepost ?>" name="rear26" width ="70%"id="fe182" /></td>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">Front Saddle</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontSaddle ?>" name="rear27" width ="70%"id="fe183" /></td>

  </tr>
  <tr>
    <td height="31" align="center">28</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->LHSBottomRail?>"name="rear28" width ="70%"id="fe184" /></td>
  
  </tr>
  <tr>
    <td  align="center">29</td>
    <td style="font: bold 20px Times New Roman">Saddle Guesset</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSSaddleGuesset ?>" name="rear29" width ="70%"id="fe185" /></td>
    
  </tr>
    <tr>
    <td  valign="right" align="center">30</td>
    <td  style="font: bold 20px Times New Roman">ladder</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSLadder?>" name="LHS30_bobu18t" width ="70%"id="fe186" /></td>
  
  </tr>
  <tr>
    <td  align="center">31</td>
    <td style="font: bold 20px Times New Roman">Rear Saddle</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearSaddle ?>" name="rear31" width ="70%"id="fe187" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">32</td>
    <td>Rear Sidepost</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearSidepost?>" name="rear32" width ="70%"id="fe188" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">33</td>
    <td>Rear Diagonal</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearDiagnol?>" name="rear33" width ="70%"id="fe189" /></td>
  </tr>
  <tr>
    <td align="center" style="font: bold 20px Times New Roman">34</td>
    <td>Diagonal Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSDiagnolGuesset ?>" name="rear34" width ="70%"id="fe190" /></td>
  </tr>
  <tr>
    <td height="27" align="center" style="font: bold 20px Times New Roman">35</td>
    <td>Corner Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSCornerGuesset ?>" name="rear35" width ="70%"id="fe191" /></td>
  </tr>
</table>

<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 1424px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->Topplatform ?>" name="rear36" width ="70%"id="fe192" /></td>
  </tr>
  <tr>
    <td  valign="right" align="center">37</td>
    <td  style="font: bold 20px Times New Roman">Rear Top  Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRearTopRail ?>" name="rear37" width ="70%"id="fe193" /></td>
  </tr>
  <tr>
    <td align="center">38</td>
    <td  style="font: bold 20px Times New Roman">LH Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopLHTopRail?>" name="rear38" width ="70%"id="fe194" /></td>
  </tr>
  <tr>
    <td align="center">39</td>
    <td  style="font: bold 20px Times New Roman">RH Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRHTopRail?>" name="rear39" width ="70%"id="fe195" /></td>
  </tr>
  <tr>
    <td  align="center">40</td>
    <td style="font: bold 20px Times New Roman">Front Top rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopFrontTopRail ?>" name="rear40" width ="70%"id="fe196" /></td>
  </tr>
  <tr>
    <td  align="center">41</td>
    <td style="font: bold 20px Times New Roman">Removable Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRemovableRail ?>" name="rear41" width ="70%"id="fe197" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">42</td>
    <td style="font: bold 20px Times New Roman">Removable Rail Brack</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRemovableRailBrackets?>" name="rear42" width ="70%"id="fe198" /></td>
  </tr>
</table>
<table width="760"  border="1" style="position: absolute; left: 89px; top: 1674px; height: 151px;font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomLongitudes ?>" name="rear43" width ="70%"id="fe199" /></td>
  </tr>
 
  <tr>
    <td  align="center">44</td>
    <td style="font: bold 20px Times New Roman">Diagnol</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomDiagonals ?>" name="rear44" width ="70%"id="fe200" /></td>
  </tr>
  <tr>
    <td  align="center">45</td>
    <td style="font: bold 20px Times New Roman">Saddle Beams</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomSaddleBeams?>" name="rear45" width ="70%"id="fe201" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">46</td>
    <td style="font: bold 20px Times New Roman">Center Beam</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomCentreBeam?>" name="rear46" width ="70%"id="fe202" /></td>
  </tr>
</table>
<table width="990"  border="1" style="position: absolute; left: 89px; top: 1854px; height: 41px;">
  <tr>
    <th width="224" rowspan="1" scope="row"  style="font: bold 20px Times New Roman" >Inspected By:<input style="width:200px;height:25px;" type="text"value="<?php echo $row->InspectedBy ?>" name="rear47" width ="70%"id="fe203" /></th>
