...
<table width="1172" height="65" border="1" style="position: absolute; left: 89px; top: 2104px; height: 101px;">
  <tr>
   <th width="598" height="59"  valign="center" style="background-color:greenyellow;font: bold 15px Times New Roman" scope="row"><p>18T Iso frame record inspection</p>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 3100px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  ...
  <tr>
    ...
    <tr>
    <td  valign="right" align="center">31</td>
    <td  style="font: bold 20px Times New Roman">ladder</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->LHSLadder?>" name="LHSLadder" width ="70%"id="fe16" /></td>
  ...
  <tr>
    <td   height="27" align="center">33</td>
    <td>Rear Sidepost</td>
...
<form id="form221" action="<?php echo site_url('isocontainer/isoinspectionrecord') ?>" method="POST">
    ...
    <td width="199" height="61" align="center" style="background-color:lightseagreen;">
        <label style="background-color:lightseagreen;font-weight:bold;font-size: 24px;">Issue:F02.23</label>
        
    </td>
    <td width="141" height="61px" style="background-color:lightseagreen;font-weight:bold;font-size: 24px;" align="center"> Page 1 of 2</td>
    <td width="180" height="61" align="center" style="background-color:lightseagreen;">
      <label style="background-color:lightseagreen;font-weight:bold;font-size: 24px;">REVISION</label>
      </td>
  </tr>
  <tr>
    <td height="35" colspan="2" align="center" style="background-color:greenyellow;font-weight:bold;font-size: 24px;">14T/18T ISO Container Inspection Record</td>
    <td colspan="2" align="center" style="background-color:greenyellow;">
      <label for="tx3"style="background-color:greenyellow;font-weight:bold;font-size: 24px;">Vessel ID: BOBU000</label>
      <input style="background-color:greenyellow;font-weight:bold;font-size: 16px;"type="text" value="<?php echo $equipmentid?>" name="vesselid" id="tx3" />
  </td>
  </tr>
</table>
 ...
 <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:800px;" id="btn53" value="10" onclick="setColor('btn53','#fff200');" /> 
  ...
  <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:155px;top:310px;" id="btn63" value="59" onclick="setColor('btn63','yellow');" /> 
   ...
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-weight: bold;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:925px;top:310px;" id="botn68" value="64" onclick="setColor('botn68','#fff200');" /> 
...
property.style.backgroundColor = "red";
    ...
    <td width="228" height="101" align="center" style="background-color:lightseagreen;">
        ...
        <input name="tx1" type="text" id="tx1" value="" />
    </td>
...
<p>
  ...
  <input type="text" value="<?php echo $row4->FrameFitforServiceSignature?>"name="section5staff" id="section5staff" />
  <label for="datepicker5">Date</label>
  <input type="text" value="<?php echo $row4->FrameFitForServiceDate?>"name="datepicker5" id="datepicker5" />
 ...
 <tr>
    <td height="176" colspan="4" >
     <div class="well">
        ...
        <label>Date</label>
        <input type="text" value = "<?php echo $row5->Dryness_Date1 ?>"name="DryDate1" style="width:100px;"  value="" />  <label>Time</label><input type="text" style="width:100px;"  name="dryTime1"   value="<?php echo $row5->Dryness_Time1?>" />  <label>Pressure</label><input type="text"  style="width:100px;"  name="DryPressu1"   value="<?php echo $row5->Dryness_Pressure1?>" />  <label>Psig</label> <label> Dryness</label>
        <input type="text" value = "<?php echo $row5->Dryness_DryC1 ?>"name="DryC1"  style="width:100px;"   value="" /><label>C</label>   <br>
        <label>Date</label>
        <input type="text" value = "<?php echo $row5->Dryness_Date2 ?>"name="DryDate2" style="width:100px;"  value="" />  <label>Time</label><input type="text" style="width:100px;"  name="dryTime2"   value="<?php echo $row5->Dryness_Time2?>" />  <label>Pressure</label><input type="text"  style="width:100px;"  name="DryPressu2"   value="<?php echo $row5->Dryness_Pressure1?>" />  <label>Psig</label> <label> Dryness</label>
  ...
  <tr>
    <td height="176" colspan="4" >
     <div class="well">
        ...
        <label>The internal atmosphere of vessel was tested for dryness with the following results: </label><br></br>
        <label>Date</label>
        <input type="text" value = "<?php echo $row5->Certified_Date ?>"name="CertifiedDate" style="width:100px;"  value="" />  <label>Time</label>
        <input type="text" value = "<?php echo $row5->Certified_Time ?>"style="width:100px;"  name="CertifiedTime"   value="" />  <label>By</label>
