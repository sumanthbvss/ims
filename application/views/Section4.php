...
<div class="navbar navbar-inverse navbar-static-top">
 ...
 <li>                 
<a
href="http://www.chemtura.com" ><button style="height:33px" type="button" value="Login" class="btn btn-success"> <span class="glyphicon glyphicon-user"></SPAN>Login</button>
...
<body><table width="989" border="1" style="position: absolute; left: 167px; top: 0px; width: 754px; height: 388px; font-weight: bold; font-family: 'Times New Roman', Times, serif;">
 
 <tr>
     <td height="35" colspan="3" align="center">
         <img src="..\car\greatlakes.png" style="position: absolute;height:25%;top:5%;left:0px;"  />
     </td>
