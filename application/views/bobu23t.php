...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 234px; height: 181px;">
  ...
  <tr>
    ...
    <td><input class="username" style="width:200px;" type="text" value="<?php echo $row->RearTopRail ?>" name="RearTopRail" width ="70%"id="fe165" /></td>
  </tr>
</table>
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 468px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  ...
  <tr>
    ...
    <td>Ladder</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSLadder ?>" name="RHSLadder" width ="70%"id="fe174" /></td>
  </tr>
  <tr>
    <td height="27" align="center" style="font: bold 20px Times New Roman">17</td>
    <td>PlateForm Vertical Sup</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSplatformverticalsup ?>" name="RHSplatformverticalsup" width ="70%"id="fe175" /></td>
  </tr>
</table>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 804px; height: 181px;">
  ...
  <tr>
    ...
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontDiagonal ?>" name="Front18_bobu18t" width ="70%"id="fe176" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontTopRail ?>" name="FrontTopRail" width ="70%"id="fe180" /></td>
  </tr>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 1048px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHShandrailoperating ?>" name="RHShandrailoperating" width ="70%"id="fe86" /> </td>
  ...
  <tr>
    ...
    <td>Ladder</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSLadder ?>" name="LHSLadder" width ="70%"id="fe190" /></td>
  </tr>
  <tr>
    <td height="27" align="center" style="font: bold 20px Times New Roman">35</td>
    <td>Platform vertical sup</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSplatformverticalsup ?>" name="LHSplatformverticalsup" width ="70%"id="fe191" /></td>
  </tr>
</table>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 1424px; height: 181px;">
  ...
  <tr>
    ...
    <td> <input class="username" style="width:200px;" type="text"value="<?php echo $row->TOPhandrails ?>" name="TOPhandrails" width ="70%"id="fe193" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRemovableRail ?>" name="rear41" width ="70%"id="fe196" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">41</td>
    <td style="font: bold 20px Times New Roman">Removable Rail Brackets</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRemovableRailBrackets?>" name="rear42" width ="70%"id="fe197" /></td>
  </tr>
</table>
...
<table width="990"  border="1" style="position: absolute; left: 89px; top: 1854px; height: 41px;">
  <tr>
    <th width="224" rowspan="1" scope="row"  style="font: bold 20px Times New Roman" >Inspected By:<input class="username" style="width:200px;height:25px;" type="text"value="<?php echo $row->InspectedBy ?>" name="rear47" width ="70%"id="fe203" /></th>
