...
<table width="994"  border="1" style="position: absolute; left: 89px; top: 250px; height: 125px;">
  <tr>
    <th width="224" rowspan="7" scope="row"  style="font: bold 25px Times New Roman" ><p>Rear</p></th>
    <td width="78" style="font-weight: bold "  align="center">1</td>
    <td   style="font: bold 20px Times New Roman" width="231"> Diagonal</td>
    <td width="181">
    <input class="username" style="width:200px;" type="text" value="<?php echo $row->RearDiagnoll; ?>" name="rear1_bobu18t" width ="80%"id="fe1611" /></td>
  ...
  <tr>
    <td style="font-weight: bold "  valign="right" align="center">2</td>
  ...
  <tr>
    ...
    <td>
    <input class="username" style="width:200px;" type="text" value="<?php echo $row->RearBottomRail;?>"  name="rear3" width ="80%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">4</td>
    <td  style="font: bold 20px Times New Roman">Corner casting</td>
    <td>
    <input class="username" style="width:200px;" type="text" value="<?php echo $row->RearCornerCasting;?>"  name="rear4" width ="80%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "   align="center">5</td>
    <td style="font: bold 20px Times New Roman">Corner Post</td>
    <td>
   <input class="username" style="width:200px;" type="text" value="<?php echo $row->RearCornerPost;?>"  name="rear5" width ="80%"id="fe16" /></td>
  </tr>
   <tr>
  
    <td style="font-weight: bold "  width="78" align="center">6</td>
    <td   style="font: bold 20px Times New Roman" width="231">Platform Support</td>
    <td width="199">
    <input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSPlatformSupport ?>" name="RHSPlatformSupport" width ="70%"id="fe16" /></td>
   
    
  </tr>
   <tr>
    <td style="font-weight: bold "   valign="right" align="center">7</td>
    <td  style="font: bold 20px Times New Roman">Ladder</td>
    <td  style="font: bold 20px Times New Roman">
        <input  class="username" style="width:200px;" type="text"value="<?php echo $row->RHSLadder ?>" name="RHSLadder" width ="70%"id="fe16" /></td>
  
  </tr>
</table>
<table width="994"  border="1" style="position: absolute; left: 89px; top: 565px; height: 300px; ">
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontDiagonal ?>" name="rear8" width ="70%"id="fe16" /></td>
 <th width="224" rowspan="12" scope="row"  style="font: bold 25px Times New Roman" ><img style="width:200px;" src="\ims\image\15TInspection RHS.jpg" /></th>
  ...
  <tr>
    <td style="font-weight: bold "  height="31" align="center">9</td>
    <td  style="font: bold 20px Times New Roman">Front Side Post</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSidePost ?>" name="rear9" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td style="font-weight: bold "  height="31" align="center">10</td>
    <td  style="font: bold 20px Times New Roman">Front Saddle</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSaddle ?>" name="rear10" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td style="font-weight: bold "  height="31" align="center">11</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSidePost ?>" name="rear11" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">12</td>
    <td style="font: bold 20px Times New Roman">Saddle Guesset</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSSaddleGusset ?>"name="rear12" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">13</td>
    <td style="font: bold 20px Times New Roman">Rear Saddle</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSRearSaddle ?>"name="rear13" width ="70%"id="fe16" /></td>
 
  </tr>
  <tr>
    <td style="font-weight: bold "   align="center">14</td>
    <td style="font: bold 20px Times New Roman">Rear Sidepost</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSRearSidePost ?>"name="rear14" width ="70%"id="fe16" /></td>
    
  </tr>
    <tr>
    <td style="font-weight: bold "  align="center" >15</td>
    <td style="font: bold 20px Times New Roman">Rear Diagonal</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSRearDiagonal ?>" name="rear15" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center" >16</td>
    <td style="font: bold 20px Times New Roman">Diagonal Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSDiagonalGusset ?>" name="rear16" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center" >17</td>
    <td style="font: bold 20px Times New Roman">Corner Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSCornerGusset ?>" name="rear17" width ="70%"id="fe16" /></td>
  </tr>
</table>

<table width="994" height="207" border="1" style="position: absolute; left: 89px; top: 940px; height: 175px;">
  <tr>
    <th width="224" rowspan="6" scope="row"  style="font: bold 25px Times New Roman" ><p>Front</p></th>
    <td style="font-weight: bold "  width="78" align="center">18</td>
    <td   style="font: bold 20px Times New Roman" width="231">Diagonal</td>
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontLongDiagonal ?>" name="rear18" width ="70%"id="fe16" /></td>
  ...
  <tr>
    <td style="font-weight: bold "  valign="right" align="center">19</td>
    <td  style="font: bold 20px Times New Roman"></td>
    <td></td>
  </tr>
  
  <tr>
    <td style="font-weight: bold "  align="center">20</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontBottomRail ?>" name="rear20" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold " align="center">21</td>
    <td  style="font: bold 20px Times New Roman">Corner casting</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontCornerCasting?>" name="rear21" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "   align="center">22</td>
    <td style="font: bold 20px Times New Roman">Corner Post</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontCornerPost ?>" name="rear22" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">23</td>
    <td style="font: bold 20px Times New Roman"></td>
    <td></td>
  </tr>
  <tr>
...
<table width="994" height="298" border="1" style="position: absolute; left: 89px; top: 1168px; height: 290px; ">
  <tr>
    <th width="224" rowspan="12" scope="row"  style="font: bold 25px Times New Roman" ><p>Left Hand Side</p></th>
    <td  style="font-weight: bold "   height="27" align="center">24</td>
    <td style="font: bold 20px Times New Roman">Corner Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontCornerGusset?>" name="rear24" width ="70%"id="fe16" /></td>
  ...
  <tr>
    <td style="font-weight: bold "  width="78" align="center">25</td>
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonal ?>" name="rear25" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "   valign="right" align="center">26</td>
    <td  style="font: bold 20px Times New Roman">Front Sidepost</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontSidepost ?>" name="rear26" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">Front Saddle</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontSaddle ?>" name="rear27" width ="70%"id="fe16" /></td>

  </tr>
  <tr>
    <td style="font-weight: bold "  height="31" align="center">28</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->LHSBottomRail?>"name="rear28" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">29</td>
    <td style="font: bold 20px Times New Roman">Saddle Guesset</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSSaddleGuesset ?>" name="rear29" width ="70%"id="fe16" /></td>
    
  </tr>
    <tr>
    <td style="font-weight: bold "  valign="right" align="center">30</td>
    <td  style="font: bold 20px Times New Roman">ladder</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSLadderHandrail?>" name="rear30" width ="70%"id="fe16" /></td>
  
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">31</td>
    <td style="font: bold 20px Times New Roman">Rear Saddle</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearSaddle ?>" name="rear31" width ="70%"id="fe16" /></td>
 
  </tr>
  <tr>
    <td style="font-weight: bold "    align="center">32</td>
    <td style="font: bold 20px Times New Roman">Rear Sidepost</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearSidepost?>" name="rear32" width ="70%"id="fe16" /></td>
    
  </tr>
    <tr>
    <td style="font-weight: bold "  align="center" >33</td>
    <td style="font: bold 20px Times New Roman">Rear Diagonal</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearDiagnol?>" name="rear33" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">34</td>
    <td style="font: bold 20px Times New Roman">Diagonal Guesset</td>
    <td><input  class="username" style="width:200px;" type="text"value="<?php echo $row->LHSDiagnolGuesset ?>" name="rear34" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center" >35</td>
    <td style="font: bold 20px Times New Roman">Corner Guesset</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSCornerGuesset ?>" name="rear35" width ="70%"id="fe16" /></td>
  </tr>
</table>

<table width="994" height="207" border="1" style="position: absolute; left: 89px; top: 1542px; height: 181px;">
  <tr>
    <th width="224" rowspan="7" scope="row"  style="font: bold 25px Times New Roman" ><p>Top</p></th>
    <td style="font-weight: bold "  width="78" align="center">36</td>
    <td   style="font: bold 20px Times New Roman" width="231">Platform</td>
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->Topplatform ?>" name="rear36" width ="70%"id="fe16" /></td>
  ...
  <tr>
    <td style="font-weight: bold "  valign="right" align="center">37</td>
    <td  style="font: bold 20px Times New Roman">Rear Top  Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRearTopRail ?>" name="rear37" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">38</td>
    <td  style="font: bold 20px Times New Roman">LH Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopLHTopRail?>" name="rear38" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">39</td>
    <td  style="font: bold 20px Times New Roman">RH Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRHTopRail?>" name="rear39" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">40</td>
    <td style="font: bold 20px Times New Roman">Front Top rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopFrontTopRail ?>" name="rear40" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">41</td>
    <td style="font: bold 20px Times New Roman">Removable Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRemovableRail ?>" name="rear41" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td  style="font-weight: bold "  height="27" align="center">42</td>
    <td style="font: bold 20px Times New Roman">Removable Rail Brack</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRemovableRailBrackets?>" name="rear42" width ="70%"id="fe16" /></td>
  </tr>
</table>
<table width="994"  border="1" style="position: absolute; left: 89px; top: 1848px; height: 100px;">
  <tr>
    <th width="224" rowspan="4" scope="row"  style="font: bold 25px Times New Roman" ><p>Bottom</p></th>
    <td style="font-weight: bold "  width="78" align="center">43</td>
    <td   style="font: bold 20px Times New Roman" width="231">Longitude</td>
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomLongitudes ?>" name="rear43" width ="70%"id="fe16" /></td>
  ...
  <tr>
    <td style="font-weight: bold "  align="center">44</td>
    <td style="font: bold 20px Times New Roman">Diagnol</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomDiagonals ?>" name="rear44" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td style="font-weight: bold "  align="center">45</td>
    <td style="font: bold 20px Times New Roman">Saddle Beams</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomSaddleBeams?>" name="rear45" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td  style="font-weight: bold "   height="27" align="center">46</td>
    <td style="font: bold 20px Times New Roman">Center Beam</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomCentreBeam?>" name="rear46" width ="70%"id="fe16" /></td>
  </tr>
</table>
<table width="994"  border="1" style="position: absolute; left: 89px; top: 1975px; height: 41px;">
  <tr>
...
if(inp.val() === ""){
        $('#fe167').val('ok'); 
           ...
           <button type ="submit" align="center" onclick="changetocolor22('yellow')" style="position:absolute;top:2070px;text-align: left;width:70px;left:500px;"id="btnimp"  name="save"  class="btn btn-danger">Submit</button>
           <button type ="submit" align="center" onclick="changetocolor22('red')" style="position:absolute;top:2070px;text-align: left;width:70px;left:630px;"id="btnssaimp"  name="sasave"  class="btn btn-danger">Finish</button>
                </div>
</form>
        </div>
