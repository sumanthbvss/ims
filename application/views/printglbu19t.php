...
<img src="\ims\image\191.png" style="position: absolute; left: 850px; top: 2205px; height:190px; width: 223px;" />

<img src="\ims\image\192.png" style="position: absolute; left: 853px; top:2420px;height:275px; width: 242px;" />
<img src="\ims\image\193.png" style="position: absolute; left: 853px; top:2850px;height:245px; width: 242px;" />
<img src="\ims\image\194.png" style="position: absolute; left: 853px; top:3100px;height:295px; width: 252px;" />
<img src="\ims\image\196.png" style="position: absolute; left: 853px; top:3510px;height:225px; width: 242px;" />
<img src="\ims\image\195.png" style="position: absolute; left: 853px; top:3750px;height:195px; width: 222px;" />
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 2205px; height: 181px;">
  <tr>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top:2420px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->RHSPlatformSupport?>" name="RHSPlatformSupport" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
   <td width="81" align="center">6</td>
    <td   style="font: bold 20px Times New Roman" width="231">FrontBrace</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->RHSFrontBrace?>" name="RHSFrontBrace" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">7</td>
    <td  style="font: bold 20px Times New Roman">Rear Brace</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->RHSRearBrace ?>" name="RHSRearBrace" width ="70%"id="fe16" /></td>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top:2850px; height: 181px;">
 <tr>
    <th width="224" rowspan="4" scope="row"  style="font: bold 25px Times New Roman" ><p>Front</p></th>
    <td width="78" align="center">18</td>
    <td   style="font: bold 20px Times New Roman" width="231">Diagonal</td>
    <td width="199"><input style="width:200px;" type="text"value="<?php echo $row->FrontDiagonal ?>" name="Front18_bobu18t" width ="70%"id="fe16" /></td>
  </tr>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top:3100px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->LHSRearbrace?>" name="LHSRearbrace" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->LHSFrontbrace?>" name="LHSFrontbrace" width ="70%"id="fe16" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">24</td>
    <td  style="font: bold 20px Times New Roman">Platform Support</td>
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->LHSPlatformSupport?>" name="LHS24_bobu18t" width ="70%"id="fe16" /></td>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top:3510px; height: 181px;">
  <tr>
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text"value="<?php echo $row->Toptoprail?>" name="Toptoprail" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">42</td>
    <td style="font: bold 20px Times New Roman">Ladder</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->Topladder?>" name="Topladder" width ="70%"id="fe16" /></td>
  </tr>
</table>
<table width="760"  border="1" style="position: absolute; left: 89px; top:3750px; height: 81px;">
...
<form id="form221" action="<?php echo site_url('isocontainer/isoinspectionrecord') ?>" method="POST">
 ...
 <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:800px;" id="btn53" value="10" onclick="setColor('btn53','#fff200');" /> 
  ...
  <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:155px;top:310px;" id="btn63" value="59" onclick="setColor('btn63','yellow');" /> 
   ...
   <input  type="text" name="repairs" value="<?php echo $row3->repairs ?>" cols="30" style="width: 880px;height: 88px;top:1520px;z-index: 10;position: absolute;left:160px;"rows="2"></textarea>
   
    <input type="text" id="tb2" name ="hcells"style="display: none;"   class="input-xlarge">
   
   
    <img src="\ims\image\rings19.png" style="position: absolute; left: 153px; top: 150px; height:310px; width: 900px;" />
    <label style="position: absolute; left: 50px; top: 820px;font-size: 35px" >Front</label>
     ...
     <label style="position: absolute; left: 1060px; top: 820px;font-size: 35px" >Rear</label>
         <img src="\ims\image\ajay1.png" style="position: absolute; left: 150px; top: 700px; height:310px; width: 900px;" />
      <img src="\ims\image\zoomm.jpg" style="position: absolute; left: 150px; top: 1350px; height:310px; width: 900px;" />
 <img src="\ims\image\pic23.png" style="position: absolute; left: 150px; top: 460px; height:200px; width: 900px;" />
 
 <img src="\ims\image\aoculastvv.jpg" style="position: absolute; left: 150px; top: 1060px; height:250px; width: 900px;" />
...
property.style.backgroundColor = "red";
    ...
    <td height="101" colspan="2"><img src="\ims\image\download.jpg"  width="224" height="97" alt="chem" /></td>
  ...
  <tr>
    <td height="35" colspan="3" align="center" style="background-color:greenyellow;">19T ISO Frame Inspection Record</td>
...
<p>&nbsp;</p>
 ...
 <h2></h2>   
  ...
  <tr>
    <td>Manlid Blank </td>
    <td colspan="2"><input type="text" style="width:99%;"value = "<?php echo $row5->manlidblank_RepairsorReplacements ?>"name="ML1"  id="textfield17" /></td>
    
    <td colspan="2"><input type="text" style="width:99%;"value = "<?php echo $row5-> manlidblank_RepairNo?>"name="ML2"  id="textfield6" /></td>
  ...
  <tr>
    <td>Valve Blanks </td>
    <td colspan="2"><input type="text" style="width:99%;"value = "<?php echo $row5->ValveBlanks_RepairsorReplacements ?>"name="VB1"  id="textfield17" /></td>
    
    <td colspan="2"><input type="text" style="width:99%;"value = "<?php echo $row5-> ValveBlanks_RepairNo?>"name="VB2"  id="textfield6" /></td>
