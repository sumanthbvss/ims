   ...
   <li>
       ...
       <input type="hidden" style="position:absolute;top:79%;width:71px;height:25px;" name="wokid" value="<?php echo $workorderid ?>" id="f21e41" />
         ...
         <input style="width:200px;" type="hidden" name="coid" width ="70%"id="cnt641" value="<?php echo $containersize ?>" />
          ...
          <a ><button  type="submit" value="Staff Management" style="width:200px;Height:50px;color:black;"class="btn btn-primary"> <span class="glyphicon glyphicon-home"></SPAN>  Home </button></a>
               </form>  </li>
...
<img src="..\image\191.png" style="position: absolute; left: 850px; top: 215px; height:190px; width: 223px;" />

<img src="..\image\192.png" style="position: absolute; left: 853px; top: 463px;height:275px; width: 242px;" />
<img src="..\image\193.png" style="position: absolute; left: 853px; top: 788px;height:245px; width: 242px;" />
<img src="..\image\194.png" style="position: absolute; left: 853px; top: 1168px;height:295px; width: 252px;" />
<img src="..\image\196.png" style="position: absolute; left: 853px; top: 1550px;height:225px; width: 242px;" />
<img src="..\image\195.png" style="position: absolute; left: 853px; top: 1800px;height:195px; width: 222px;" />
...
<table width="1172" height="65" border="1">
  <tr>
   <th width="598" height="59"  valign="center" style="background-color:greenyellow;font: bold 15px Times New Roman" scope="row"><p>19T Iso frame record inspection</p>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 21h4px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
    <th width="224" rowspan="4" scope="row"  style="font: bold 25px Times New Roman" ><p>Rear</p></th>
    <td width="78" align="center">1</td>
    <td   style="font: bold 20px Times New Roman" width="231">Diagonal</td>
    <td width="199"><input class="username" style="width:200px;" value="<?php echo $row->RearDiagnoll; ?>" type="text" name="rear1_bobu18t" width ="70%"id="fe1611" /></td>
  </tr>
  
  <tr>
    <td align="center">2</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td><input class="username" style="width:200px;" type="text" value="<?php echo $row->RearBottomRail;?>"  name="rear3" width ="70%"id="fe162" /></td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td  style="font: bold 20px Times New Roman">Corner casting</td>
    <td><input class="username" style="width:200px;" type="text" value="<?php echo $row->RearCornerCasting;?>"  name="rear4" width ="70%"id="fe163" /></td>
  </tr>
  <tr>
    <td  align="center">4</td>
    <td style="font: bold 20px Times New Roman">Corner Post</td>
    <td><input class="username" style="width:200px;" type="text" value="<?php echo $row->RearCornerPost;?>"  name="rear5" width ="70%"id="fe164" /></td>
  </tr>
 
  
</table>
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 398px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    <th width="220" rowspan="11" scope="row"  style="font: bold 25px Times New Roman" ><p>Right Hand Side</p></th>
    <td width="81" align="center">5</td>
    <td   style="font: bold 20px Times New Roman" width="231">Platform Support</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSPlatformSupport?>" name="RHSPlatformSupport" width ="70%"id="fe165" /></td>
    
  </tr>
  <tr>
   <td width="81" align="center">6</td>
    <td   style="font: bold 20px Times New Roman" width="231">FrontBrace</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontBrace?>" name="RHSFrontBrace" width ="70%"id="fe166" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">7</td>
    <td  style="font: bold 20px Times New Roman">Rear Brace</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSRearBrace ?>" name="RHSRearBrace" width ="70%"id="fe167" /></td>
  
  </tr>
  <tr>
   <td width="81" align="center">8</td>
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontDiagonal ?>" name="rear8" width ="70%"id="fe168" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">9</td>
    <td  style="font: bold 20px Times New Roman">Front Sidepost</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSidePost ?>" name="rear9" width ="70%"id="fe169" /></td>
  
  </tr>
  <tr>
    <td align="center">10</td>
    <td  style="font: bold 20px Times New Roman">Front Saddle</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSFrontSaddle ?>" name="rear10" width ="70%"id="fe170" /></td>

  </tr>
  <tr>
    <td height="31" align="center">11</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->RHSBottomRail ?>" name="rear11" width ="70%"id="fe171" /></td>
  
  </tr>
  <tr>
    <td  align="center">12</td>
    <td style="font: bold 20px Times New Roman">Saddle Guesset</td>
    <td style="font: bold 20px Times New Roman"><input  class="username" style="width:200px;" type="text" value="<?php echo $row->RHSSaddleGusset ?>"name="rear12" width ="70%"id="fe172" /></td>
    
  </tr>
  <tr>
    <td  align="center">13</td>
    <td style="font: bold 20px Times New Roman">Rear Saddle</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSRearSaddle ?>"name="rear13" width ="70%"id="fe173" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">14</td>
    <td>Rear Sidepost</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->RHSRearSidePost ?>"name="rear14" width ="70%"id="fe174" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">15</td>
    <td>Rear Diagonal</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->RHSRearDiagonal ?>" name="rear15" width ="70%"id="fe175" /></td>
  </tr>
  <tr>
</table>

<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 834px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
    <th width="224" rowspan="4" scope="row"  style="font: bold 25px Times New Roman" ><p>Front</p></th>
    <td width="78" align="center">18</td>
    <td   style="font: bold 20px Times New Roman" width="231">Diagonal</td>
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontDiagonal ?>" name="Front18_bobu18t" width ="70%"id="fe176" /></td>
  </tr>
 
  <tr>
    <td align="center">19</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontBottomRail ?>" name="rear20" width ="70%"id="fe177" /></td>
  </tr>
  <tr>
    <td align="center">20</td>
    <td  style="font: bold 20px Times New Roman">Corner casting</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontCornerCasting?>" name="rear21" width ="70%"id="fe178" /></td>
  </tr>
  <tr>
    <td  align="center">21</td>
    <td style="font: bold 20px Times New Roman">Corner Post</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->FrontCornerPost ?>" name="rear22" width ="70%"id="fe179" /></td>
  </tr>
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 1048px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    <th width="220" rowspan="13" scope="row"  style="font: bold 25px Times New Roman" ><p>Left Hand Side</p></th>
    <td width="81" align="center">22</td>
    <td   style="font: bold 20px Times New Roman" width="231">Rear Brace</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearbrace?>" name="LHSRearbrace" width ="70%"id="fe180" /></td>
    
  </tr>
  <tr>
    
    <td width="81" align="center">23</td>
    <td   style="font: bold 20px Times New Roman" width="231">Front Brace</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontbrace?>" name="LHSFrontbrace" width ="70%"id="fe181" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">24</td>
    <td  style="font: bold 20px Times New Roman">Platform Support</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSPlatformSupport?>" name="LHS24_bobu18t" width ="70%"id="fe182" /></td>
  ...
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonal ?>" name="rear25" width ="70%"id="fe183" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">26</td>
    <td  style="font: bold 20px Times New Roman">Front Sidepost</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontSidepost ?>" name="rear26" width ="70%"id="fe184" /></td>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">Front Saddle</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSFrontSaddle ?>" name="rear27" width ="70%"id="fe185" /></td>

  </tr>
  <tr>
    <td height="31" align="center">28</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text" value="<?php echo $row->LHSBottomRail?>"name="rear28" width ="70%"id="fe186" /></td>
  
  </tr>
  <tr>
    <td  align="center">29</td>
    <td style="font: bold 20px Times New Roman">Saddle Guesset</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSSaddleGuesset ?>" name="rear29" width ="70%"id="fe187" /></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Rear Saddle</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearSaddle ?>" name="rear31" width ="70%"id="fe188" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">32</td>
    <td>Rear Sidepost</td>
    <td style="font: bold 20px Times New Roman"><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearSidepost?>" name="rear32" width ="70%"id="fe189" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">33</td>
    <td>Rear Diagonal</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->LHSRearDiagnol?>" name="rear33" width ="70%"id="fe190" /></td>
  </tr>
</table>

<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 1574px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td width="199"><input class="username" style="width:200px;" type="text"value="<?php echo $row->Topplatform ?>" name="rear36" width ="70%"id="fe191" /></td>
  </tr>
  <tr>
    <td  valign="right" align="center">37</td>
    <td  style="font: bold 20px Times New Roman">Rear Top  Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRearTopRail ?>" name="rear37" width ="70%"id="fe192" /></td>
  </tr>
  <tr>
    <td align="center">38</td>
    <td  style="font: bold 20px Times New Roman">LH Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopLHTopRail?>" name="rear38" width ="70%"id="fe193" /></td>
  </tr>
  <tr>
    <td align="center">39</td>
    <td  style="font: bold 20px Times New Roman">RH Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopRHTopRail?>" name="rear39" width ="70%"id="fe194" /></td>
  </tr>
  <tr>
    <td  align="center">40</td>
    <td style="font: bold 20px Times New Roman">Front Top rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->TopFrontTopRail ?>" name="rear40" width ="70%"id="fe195" /></td>
  </tr>
  <tr>
    <td  align="center">41</td>
    <td style="font: bold 20px Times New Roman">Top Rail</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->Toptoprail?>" name="Toptoprail" width ="70%"id="fe196" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">42</td>
    <td style="font: bold 20px Times New Roman">Ladder</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->Topladder?>" name="Topladder" width ="70%"id="fe197" /></td>
  </tr>
</table>
<table width="760"  border="1" style="position: absolute; left: 89px; top: 1844px; height: 81px;font-weight: bold; font-size: 18px;">
  
  <tr>
       <th width="224" rowspan="2" scope="row"  style="font: bold 25px Times New Roman" ><p>Bottom</p></th>
    <td  align="center">43</td>
    <td style="font: bold 20px Times New Roman">Diangonals</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomDiagonals ?>" name="rear44" width ="70%"id="fe198" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">44</td>
    <td style="font: bold 20px Times New Roman">Saddle Beams</td>
    <td><input class="username" style="width:200px;" type="text"value="<?php echo $row->BottomSaddleBeams?>" name="rear45" width ="70%"id="fe199" /></td>
  </tr>
</table>
<table width="990"  border="1" style="position: absolute; left: 89px; top: 2004px; height: 41px;">
  <tr>
    <th width="224" rowspan="1" scope="row"  style="font: bold 20px Times New Roman" >Inspected By:<input class="username" style="width:200px;height:25px;" type="text"value="<?php echo $row->InspectedBy ?>" name="rear47" width ="70%"id="fe200" /></th>
    <td width="78" align="center">Date:<input class="username" style="font: bold 20px Times New Roman;width:150px;" type="text" value="<?php echo $row->Datepage1 ?>"name="rear48" width ="70%"id="datepicker1" /></td>
   <script>
...
if(inp.val() === ""){
 ...
 function changetocolor22(color){
  ...
  document.getElementById("readcolor1").value = color;
           ...
           <button type ="submit" onclick="changetocolor22('yellow')" style="position:absolute;top:2060px;text-align: left;width:125px;left:600px;"id="btnimp"  name="save"  class="btn btn-danger">Submit</button>
               <button type ="submit" onclick="changetocolor22('red')" style="position:absolute;top:2060px;text-align: left;width:125px;left:730px;"id="btnssaimp"  name="sasave"  class="btn btn-danger">Finish</button>
                </div>
</form>
        </div>
...
<form id="form221" onkeypress="return event.keyCode !== 13;" action="<?php echo site_url('isocontainer/isoinspectionrecord') ?>" method="POST">
  ...
  <tr>
    <td height="35" colspan="2" align="center" style="font-weight:bold;font-size: 24px;">19T ISO Container Inspection Record</td>
 ...
 <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:800px;" id="btn53" value="10" onclick="setColor('btn53','#fff200');" /> 
  ...
  <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:155px;top:310px;" id="btn63" value="59" onclick="setColor('btn63','yellow');" /> 
   ...
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:865px;top:310px;" id="btin65" value="63" onclick="setColor('btin65','yellow');" /> 
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:935px;top:310px;" id="bktn66" value="64" onclick="setColor('bktn66','#fff200');" /> 
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:555px;top:250px;" id="bhtn63" value="61" onclick="setColor('bhtn63','yellow');" /> 
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:655px;top:290px;" id="btkn60" value="60" onclick="setColor('btkn60','#fff200');" /> 
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:555px;top:355px;" id="bttn58" value="62" onclick="setColor('bttn58','#fff200');" /> 
   ...
   <input type="button"class="default span btn" style="width: 34px;z-index: 10;height: 34px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;position:absolute;z-index: 10;font-weight: bold;left:960px;top:240px;" id="btkp68" value="65" onclick="setColor('btkp68','#fff200');" /> 
   
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-weight: bold;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:960px;top:370px;" id="botn68" value="66" onclick="setColor('botn68','#fff200');" /> 
   ...
   <input class="username" type="text" value="<?php echo $row3->date ?>" name="datepicker" id="fe2041" style="width:160px;z-index: 10;height: 32px;text-align:left;padding: 6px;font-weight: bold;font-size: 16px;position:absolute;left:855px;top:1610px;" />
    ...
    <textarea   class="input-text"  cols="40" name="repairs" form="form221"  rows="5"    placeholder="" cols="30" style="width: 880px;height: 128px;top:1480px;z-index: 10;position: absolute;left:160px;"/><?php echo $row3->repairs ?></textarea>
     <input type="text" id="tb2" name ="hcells"style="display: none;"   class="input-xlarge">
   
   
    <img src="..\image\rings19.png" style="position: absolute; left: 153px; top: 150px; height:310px; width: 900px;" />
    <label style="position: absolute; left: 50px; top: 820px;font-size: 35px" >Front</label>
     ...
     <label style="position: absolute; left: 1060px; top: 820px;font-size: 35px" >Rear</label>
         <img src="..\image\ajay1.png" style="position: absolute; left: 150px; top: 700px; height:310px; width: 900px;" />
      <img src="..\image\zoomm.jpg" style="position: absolute; left: 150px; top: 1350px; height:310px; width: 900px;" />
 <img src="..\image\pic23.png" style="position: absolute; left: 150px; top: 460px; height:200px; width: 900px;" />
 
 <img src="..\image\aoculastvv.jpg" style="position: absolute; left: 150px; top: 1060px; height:250px; width: 900px;" />
...
<input class="username" name="displayValue44" placeholder="add/select a value" id="displayValue44"value="<?php echo $row4->Section2RepairsComplete?>" style="position:absolute;top:0px;left:0px;width:180px;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
...
<input class="username" name="displayValue55" placeholder="add/select a value" id="displayValue55"value="<?php echo $row4->Section3RepairsComplete?>" style="position:absolute;top:0px;left:0px;width:180px;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
...
<input class="username" name="displayValue66" placeholder="add/select a value" id="displayValue66" value="<?php echo $row4->Section4RepairsComplete?>" style="position:absolute;top:0px;left:0px;width:180px;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
...
<input name="DP2" value = "<?php echo $row5-> DipPipe_RepairNo?>"id="t121" type="hidden">
  ...
  <tr>
    <td> Dip Pipe</td>
    <td colspan="2"><div style="position:relative;width:100%;height:25px;border:0;padding:0;margin:0;">
<select style="position:absolute;top:0px;left:0px;width:100%; height:25px;line-height:20px;margin:0;padding:0;" onchange="document.getElementById('5d4').value=this.options[this.selectedIndex].text; document.getElementById('5t4').value=this.options[this.selectedIndex].value;">
 <option ></option>
  <option value="Ok">Ok</option>
   <option value="N/A">N/A</option>
...
<input name="5F3"  id="5d4" value = "<?php echo $row5-> UllageDipPipe_RepairsorReplacements?>"  style="position:absolute;top:0px;left:0px;width:90%;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
<input name="UDP1" value = "<?php echo $row5-> UllageDipPipe_RepairsorReplacements?>"  id="5t4" type="hidden">
...
<input name="F159"  id="d121" value = "<?php echo $row5->UllageDipPipe_RepairNo?>" style="position:absolute;top:0px;left:0px;width:75%;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
<input name="UDP2" value = "<?php echo $row5-> UllageDipPipe_RepairNo?>"id="t121" type="hidden">
        </div></td>
  ...
  <tr>
    <td>Valve Blanks</td>
    <td colspan="2"><div style="position:relative;width:100%;height:25px;border:0;padding:0;margin:0;">
<select style="position:absolute;top:0px;left:0px;width:100%; height:25px;line-height:20px;margin:0;padding:0;" onchange="document.getElementById('6d4').value=this.options[this.selectedIndex].text; document.getElementById('6t4').value=this.options[this.selectedIndex].value;">
 <option ></option>
  <option value="Ok">Ok</option>
   <option value="N/A">N/A</option>
...
<input name="6F3"  id="6d4" value = "<?php echo $row5-> ValveSpacer_RepairsOrReplacements?>"  style="position:absolute;top:0px;left:0px;width:90%;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
<input name="VS1" value = "<?php echo $row5-> ValveSpacer_RepairsOrReplacements?>" id="6t4" type="hidden">
   
      </div>
    <td colspan="2"><div style="position:relative;width:100%;height:25px;border:0;padding:0;margin:0;">
<select style="position:absolute;top:0px;left:0px;width:100%; height:25px;line-height:20px;margin:0;padding:0;" onchange="document.getElementById('d1121').value=this.options[this.selectedIndex].text; document.getElementById('t121').value=this.options[this.selectedIndex].value;">
   <option ></option>
 <option value="N/A">N/A</option>
   <option value="Attached">Attached</option>

</select>
<input name="F159"  id="d1121" value = "<?php echo $row5->ValveSpacer_RepairNo?>" style="position:absolute;top:0px;left:0px;width:75%;height:100%;border:1px solid #556;" onfocus="this.select()" type="text">
<input name="VS2" value = "<?php echo $row5-> ValveSpacer_RepairNo?>"id="t121" type="hidden">
        </div></td>
