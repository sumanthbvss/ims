...
<img src="\ims\image\Rear_bobu18t.png" style="position: absolute; left: 850px; top: 2205px; height:210px; width: 223px;" />

<img src="\ims\image\RHS_bobu18t.png" style="position: absolute; left: 853px; top:2420px;height:305px; width: 242px;" />
<img src="\ims\image\front_bobu18t.png" style="position: absolute; left: 853px; top:2850px;height:265px; width: 242px;" />
<img src="\ims\image\LHS_bobu18t.png" style="position: absolute; left: 853px; top:3100px;height:315px; width: 252px;" />
<img src="\ims\image\Top_bobu18t.png" style="position: absolute; left: 853px; top:3510px;height:255px; width: 242px;" />
<img src="\ims\image\bottom_bobu18t.png" style="position: absolute; left: 853px; top:3750px;height:205px; width: 222px;" />
...
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top:2420px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->RHSLadder ?>" name="RHSLadder" width ="70%"id="fe16" /></td>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top:3510px; height: 181px;">
 <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="181"><input style="width:200px;" type="text"value="<?php echo $row->LHSPlatformSupport ?>" name="LHS24_bobu18t" width ="70%"id="fe16" /></td>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman"><input style="width:200px;" type="text"value="<?php echo $row->LHSLadder?>" name="LHS30_bobu18t" width ="70%"id="fe16" /></td>
...
<table width="760"  border="1" style="position: absolute; left: 89px; top:3750px; height: 151px;">
 <tr>
...
<form id="form221" action="<?php echo site_url('isocontainer/isoinspectionrecord') ?>" method="POST">
 ...
 <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:800px;" id="btn53" value="10" onclick="setColor('btn53','#fff200');" /> 
  ...
  <input  name="repairs" value="<?php echo $row3->repairs ?>" cols="30" style="width: 880px;height: 168px;top:1430px;z-index: 10;position: absolute;left:160px;"rows="4"/>
 ...
 <img src="\ims\image\last.jpg" style="position: absolute; left: 150px; top: 1060px; height:250px; width: 900px;" />
...
property.style.backgroundColor = "red";
  ...
  <tr>
    <td height="35" colspan="3" align="center" style="background-color:greenyellow;">AOCU 19T ISO Frame Inspection Record</td>
