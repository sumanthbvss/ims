...
href="<?php echo site_url('site')?>" ><button  type="button" value="Staff Management" class="btn btn-primary"> <span class="glyphicon glyphicon-home"></SPAN>  Home </button>
 ...
 <li>                 
<a
href="<?php echo site_url('staff/addstaff')?>" ><button  type="button" value="Staff Management" class="btn btn-primary"> <span class="glyphicon glyphicon-user"></SPAN> Add New Staff</button>
