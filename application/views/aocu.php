...
<img src="..\image\aocu1.png" style="position: absolute; left: 850px; top: 235px; height:210px; width: 223px;" />

<img src="..\image\aocu2.png" style="position: absolute; left: 853px; top: 463px;height:305px; width: 242px;" />
<img src="..\image\aocu3.png" style="position: absolute; left: 853px; top: 988px;height:265px; width: 242px;" />
<img src="..\image\aocu4.png" style="position: absolute; left: 853px; top: 1268px;height:315px; width: 252px;" />
<img src="..\image\fignew.png" style="position: absolute; left: 853px; top: 1700px;height:205px; width: 242px;" />
<img src="..\image\aocu6.png" style="position: absolute; left: 853px; top: 1950px;height:105px; width: 222px;" />
...
<table width="1172" height="65" border="1">
  <tr>
   <th width="598" height="59"  valign="center" style="font: bold 15px Times New Roman" scope="row"><p>AOCU Iso frame record inspection</p>
    </t>  <th width="558"  valign="center" height="59"   style="font: bold 15px Times New Roman" scope="row">FrameID:
    <input type="text" value="<?php echo $containersize ?>"name="techid" width ="450px"id="fe5" /></th>
  </tr>
</table>
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 214px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Number Plate</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->RearNumberPlate;?>" name="rearnumberplate" width ="70%"id="fe166" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">7</td>
    <td style="font: bold 20px Times New Roman">Hazchem Plate</td>
    <td><input class="username"  style="width:200px;" type="text" value="<?php echo $row->RearHazchemPlate ?>" name="rearhazchemplate" width ="70%"id="fe167" /></td>
  </tr>
</table>
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 468px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal-Top</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonalTop ?>" name="LHSFrontDiagonalTop" width ="70%"id="fe168" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">9</td>
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Bottom</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonalBottom ?>" name="LHSFrontDiagonalBottom" width ="70%"id="fe169" /></td>
  
  </tr>
  <tr>
    <td align="center">10</td>
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Inner</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSFrontDiagonalInner?>" name="LHSFrontDiagonalInner" width ="70%"id="fe170" /></td>

  </tr>
  <tr>
    <td height="31" align="center">11</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSBottomRail ?>" name="rear28" width ="70%"id="fe171" /></td>
  
  </tr>
  <tr>
    <td  align="center">12</td>
    <td style="font: bold 20px Times New Roman">Rear Diagonal-Inner</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text" value="<?php echo $row->LHSRearDiagonalInner ?>"name="LHSRearDiagonalInner" width ="70%"id="fe172" /></td>
    
  </tr>
  <tr>
    <td  align="center">13</td>
    <td style="font: bold 20px Times New Roman">Rear Diagonal-Bottom</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text" value="<?php echo $row->LHSRearDiagonalBottom ?>"name="LHSRearDiagonalBottom" width ="70%"id="fe173" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">14</td> <script>
...
$("#displayValue55").keyup(function (event) {
 ...
 $('#picker3').val('<?php echo date("Y/m/d"); ?>');
    ...
    <td>Middle Side Rail</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text" value="<?php echo $row->LHSMiddleSideRail ?>"name="LHSMiddleSideRail" width ="70%"id="fe174" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">15</td>
    <td>Rear Diagonal-Top</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSRearDiagonalTop?>" name="LHSRearDiagonalTop" width ="70%"id="fe175" /></td>
  </tr>
  <tr>
    <td align="center" style="font: bold 20px Times New Roman">16</td>
    <td>Ladder</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSLadder ?>" name="LHSLadder" width ="70%"id="fe176" /></td>
  </tr>
  <tr>
    <td height="27" align="center" style="font: bold 20px Times New Roman">17</td>
    <td>Step Rail</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->LHSStepRail ?>" name="LHSStepRail" width ="70%"id="fe177" /></td>
  </tr>
</table>

<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 904px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
    <th width="224" rowspan="7" scope="row"  style="font: bold 25px Times New Roman" ><p>Front</p></th>
    <td width="78" align="center">18</td>
    <td   style="font: bold 20px Times New Roman" width="231">Long Diagonal</td>
    <td width="199"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->FrontLongDiagonal ?>" name="rear18" width ="70%"id="fe178" /></td>
  </tr>
  <tr>
    <td  valign="right" align="center">19</td>
    <td  style="font: bold 20px Times New Roman">Short Diagonal</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->FrontShortDiagonal ?>" name="rear19" width ="70%"id="fe179" /></td>
  </tr>
  <tr>
    <td align="center">20</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->FrontBottomRail ?>" name="rear20" width ="70%"id="fe180" /></td>
  </tr>
  <tr>
    <td align="center">21</td>
    <td  style="font: bold 20px Times New Roman">Corner casting</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->FrontCornerCasting?>" name="rear21" width ="70%"id="fe181" /></td>
  </tr>
  <tr>
    <td  align="center">22</td>
    <td style="font: bold 20px Times New Roman">Corner Post</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->FrontCornerPost ?>" name="rear22" width ="70%"id="fe182" /></td>
  </tr>
  <tr>
    <td  align="center">23</td>
    <td style="font: bold 20px Times New Roman">Number Plate</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->frontnumberplate ?>" name="frontnumberplate" width ="70%"id="fe183" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">24</td>
    <td style="font: bold 20px Times New Roman">Hazchem Plate</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->fronthazchemplate?>" name="fronthazchemplate" width ="70%"id="fe184" /></td>
  </tr>
</table>
<table width="997" height="298" border="1" style="position: absolute; left: 87px; top: 1248px; height: 290px; width: 761px; font-weight: bold; font-size: 18px;">
  <tr>
    ...
    <td   style="font: bold 20px Times New Roman" width="231">Front Diagonal-Top</td>
    <td   style="font: bold 20px Times New Roman" width="181"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsfrontdiagonaltop ?>" name="rhsfrontdiagonaltop" width ="70%"id="fe185" /></td>
    
  </tr>
  <tr>
    <td  valign="right" align="center">26</td>
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Bottom</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsfrontdiagonalbottom ?>" name="rhsfrontdiagonalbottom" width ="70%"id="fe186" /></td>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">Front Diagonal-Inner</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsfrontdiagonalinner ?>" name="rhsfrontdiagonalinner" width ="70%"id="fe187" /></td>

  </tr>
  <tr>
    <td height="31" align="center">28</td>
    <td  style="font: bold 20px Times New Roman">Bottom Rail</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text" value="<?php echo $row->RHSBottomRail?>"name="rear11" width ="70%"id="fe188" /></td>
  
  </tr>
  <tr>
    <td  align="center">29</td>
    <td style="font: bold 20px Times New Roman">Rear Diagonal-Inner</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsreardiagonalinner ?>" name="rhsreardiagonalinner" width ="70%"id="fe189" /></td>
    
  </tr>
    <tr>
    <td  valign="right" align="center">30</td>
    <td  style="font: bold 20px Times New Roman">Rear Diagonal-Bottom</td>
    <td  style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsreardiagonalbottom?>" name="rhsreardiagonalbottom" width ="70%"id="fe190" /></td>
  
  </tr>
  <tr>
    <td  align="center">31</td>
    <td style="font: bold 20px Times New Roman">Middle Side Rail</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsmiddlesiderail ?>" name="rhsmiddlesiderail" width ="70%"id="fe191" /></td>
 
  </tr>
  <tr>
    <td   height="27" align="center">32</td>
    <td>Rear Diagonal-Top</td>
    <td style="font: bold 20px Times New Roman"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhsreardiagonaltop?>" name="rhsreardiagonaltop" width ="70%"id="fe192" /></td>
    
  </tr>
    <tr>
    <td align="center" style="font: bold 20px Times New Roman">33</td>
    <td>Ladder</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->RHSLadder?>" name="RHSLadder" width ="70%"id="fe193" /></td>
  </tr>
  <tr>
    <td align="center" style="font: bold 20px Times New Roman">34</td>
    <td>Step Rail</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->rhssteprail?>" name="rhssteprail" width ="70%"id="fe194" /></td>
  </tr>
  <tr>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top: 1674px; height: 181px;font-weight: bold; font-size: 18px;">
  <tr>
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">LH Top side Rail</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->TopLHTopSideRail?>" name="TopLHTopSideRail" width ="70%"id="fe197" /></td>
  </tr>
  <tr>
    <td align="center">39</td>
    <td  style="font: bold 20px Times New Roman">RH Top side Rail</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->TopRHTopSideRail?>" name="TopRHTopSideRail" width ="70%"id="fe198" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Roll over tube rear</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->TopRollOverTubeRear?>" name="TopRollOverTubeRear" width ="70%"id="fe201" /></td>
  </tr>
 <tr>
  
    <td width="78" align="center">43</td>
    <td   style="font: bold 20px Times New Roman" width="231">Roll over tube front</td>
    <td width="199"><input class="username"  style="width:200px;" type="text"value="<?php echo $row->BottomRollOverTubeFront ?>" name="BottomRollOverTubeFront" width ="70%"id="fe202" /></td>
  </tr>
</table>
<table width="760"  border="1" style="position: absolute; left: 89px; top: 1944px; height: 81px;font-weight: bold; font-size: 18px;">
  
 
  <tr>
        <th width="224" rowspan="1" scope="row"  style="font: bold 25px Times New Roman" ><p>Bottom</p></th>
    <td  align="center">44</td>
    <td style="font: bold 20px Times New Roman">Bottom Cross Beam</td>
    <td><input class="username"  style="width:200px;" type="text"value="<?php echo $row->BottomBottomCrossBeam ?>" name="BottomBottomCrossBeam" width ="70%"id="fe203" /></td>
  </tr>
  
</table>
<table width="990"  border="1" style="position: absolute; left: 89px; top: 2104px; height: 41px;">
  <tr>
    <th width="224" rowspan="1" scope="row"  style="font: bold 20px Times New Roman" >Inspected By:<input class="username"  style="width:200px;height:25px;" type="text"value="<?php echo $row->InspectedBy ?>" name="rear47" width ="70%"id="fe204" /></th>
    <td width="78" align="center">Date:<input class="username"  style="font: bold 20px Times New Roman;width:150px;" type="text" value="<?php echo $row->Datepage1 ?>"name="rear48" width ="70%"id="datepicker51" /></td>
   <script>
    
$("#datepicker51").keyup(function (event) {
    
    if (event.keyCode === 13) {
       var inp = $("#datepicker51");

if(inp.val() === ""){
      
        $('#datepicker51').val('<?php echo date("Y/m/d");?>');
...
if(inp.val() === ""){
        ...
        $('#fe204').val('<?php echo $this->session->userdata('username');  ?>'); 
...
if(inp.val() === ""){
 ...
 function changetocolor22(color){
  ...
  document.getElementById("readcolor1").value = color;
           ...
           <button type ="submit" onclick="changetocolor22('yellow')" style="position:absolute;top:2160px;text-align: left;width:125px;left:600px;"id="btnimp"  name="save"  class="btn btn-danger">Submit</button>
               <button type ="submit" onclick="changetocolor22('red')" style="position:absolute;top:2160px;text-align: left;width:125px;left:730px;"id="btnssaimp"  name="sasave"  class="btn btn-danger">Finish</button>
                </div>
</form>
        </div>
...
<form id="form221" onkeypress="return event.keyCode !== 13;" action="<?php echo site_url('isocontainer/isoinspectionrecord') ?>" method="POST">
  ...
  <tr>
    ...
    <td colspan="2" align="center">
      ...
      <input style="font-weight:bold;font-size: 16px;"type="text" value="<?php echo $containersize ?>" name="vesselid" id="tx3" />
  </td>
  </tr>
</table>
 ...
 <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:800px;" id="btn53" value="10" onclick="setColor('btn53','#fff200');" /> 
  ...
  <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:155px;top:310px;" id="btn63" value="59" onclick="setColor('btn63','yellow');" /> 
   ...
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:865px;top:310px;" id="btin65" value="66" onclick="setColor('btin65','yellow');" /> 
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:310px;" id="bktn66" value="64" onclick="setColor('bktn66','#fff200');" /> 
   ...
   <input type="button"class="default span btn btn-default btn-circle" style="width: 34px;z-index: 10;height: 34px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;position:absolute;z-index: 10;border-radius: 15px;font-weight: bold;left:925px;top:230px;" id="btkp68" value="67" onclick="setColor('btkp68','#fff200');" /> 
   
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-weight: bold;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:925px;top:390px;" id="botn68" value="65" onclick="setColor('botn68','#fff200');" /> 
...
<script>
    ...
    <input class="username" type="text" id="tb2" name ="hcells"style="display: none;"   class="input-xlarge">
 ...
 <img src="..\image\pic232.png" style="position: absolute; left: 150px; top: 460px; height:200px; width: 900px;" />
