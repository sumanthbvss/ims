...
<img src="\ims\image\Screenshot (4).png" style="position: absolute; left: 850px; top: 2205px; height:210px; width: 223px;" />

<img src="\ims\image\Screenshot (4)(1).png" style="position: absolute; left: 853px; top:2420px;height:305px; width: 242px;" />
<img src="\ims\image\geesa.jpg" style="position: absolute; left: 853px; top: 2850px;height:265px; width: 242px;" />
<img src="\ims\image\bomma1.png" style="position: absolute; left: 853px; top: 3100px;height:315px; width: 252px;" />
<img src="\ims\image\bomma2.png" style="position: absolute; left: 853px; top: 3510px;height:255px; width: 242px;" />
<img src="\ims\image\bomma3.png" style="position: absolute; left: 853px; top: 3750px;height:205px; width: 222px;" />
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top:2205px; height: 181px;">
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text" value="<?php echo $row->RearShortDiagonal; ?>" name="rear2" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input style="width:200px;" type="text"value="<?php echo $row->RearCentreGusset;?>" name="rear6" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
    <td   height="27" align="center">7</td>
    <td style="font: bold 20px Times New Roman">Corner Guesset</td>
    <td><input style="width:200px;" type="text" value="<?php echo $row->RearCornerGusset ?>" name="rear7" width ="70%"id="fe16" /></td>
  </tr>
</table>
...
<table width="760" height="207" border="1" style="position: absolute; left: 89px; top:2850px; height: 181px;">
  ...
  <tr>
    ...
    <td  style="font: bold 20px Times New Roman">Short Diagonal</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->FrontShortDiagonal ?>" name="rear19" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="font: bold 20px Times New Roman">Center Guesset</td>
    <td><input style="width:200px;" type="text"value="<?php echo $row->FrontCentreGusset ?>" name="rear23" width ="70%"id="fe16" /></td>
  </tr>
  <tr>
 ...
 <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;font-weight: bold;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:990px;top:800px;" id="btn53" value="10" onclick="setColor('btn53','#fff200');" /> 
  ...
  <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:155px;top:310px;" id="btn63" value="59" onclick="setColor('btn63','yellow');" /> 
   ...
   <input type="button"class="default span btn btn-default btn-circle" style="width: 28px;z-index: 10;height: 28px;text-align: center;padding: 6px;font-weight: bold;font-size: 12px;background-color: yellow;line-height: 1.42;border-radius: 15px;position:absolute;z-index: 10;left:320px;top:1170px;" id="btn165" value="50" onclick="setColor('btn165','#fff200');" /> 
    ...
    <input type="text" value="<?php echo $row3->fusible ?>"name="fusible" id="tx3 "style="width: 138px;z-index: 10;height: 32px;text-align:left;padding: 6px;font-weight: bold;font-size: 16px;position:absolute;z-index: 10;left:575px;top:1250px;" />
